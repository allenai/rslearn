...
class Sentinel2(PlanetaryComputer):
    ...
    def _get_compositor_scoring_bands(context: DataSourceContext) -> set[str]:
        """Get additional bands required by known cloud-aware compositors.

        These bands are needed during materialization for ranking, even if they are
        not part of the output layer band sets.
        """
