...
class SAM2Encoder(nn.Module):
    ...
    def __init__(self, model_identifier: str) -> None:
        ...
        if 'tiny' in model_identifier:
            ...
            checkpoint_path = UPath("gcs://rslearn-eai/artifacts/sam2/sam2_hiera_tiny.pt")
            ...
            checkpoint_path = UPath("gcs://rslearn-eai/artifacts/sam2/sam2_hiera_small.pt")
            self.backbone_channels = [
                [4, 96],
                [8, 192],
                [16, 384],
            ...
            checkpoint_path = UPath("gcs://rslearn-eai/artifacts/sam2/sam2_hiera_base_plus.pt")
            self.backbone_channels = [
                [4, 112],
                [8, 224],
                [16, 448],
            ...
            checkpoint_path = UPath("gcs://rslearn-eai/artifacts/sam2/sam2_hiera_large.pt")
            self.backbone_channels = [
                [4, 144],
                [8, 288],
                [16, 576],
